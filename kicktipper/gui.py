...
class MainWidgets(ttk.Frame):
    ...
    def __init__(self, master=None, team_array=None):
        ...
        for kk in range(18):
            ...
            self.label_ResultsList.append(ttk.Label(self, textvariable=self.v_results_list[kk]))
        ...
        for kk in range(9):
            ...
            self.label_ResultsList[2*kk].grid(row=kk, column=2)
            ttk.Label(self, text=":").grid(row=kk, column=3)
            self.label_ResultsList[2*kk+1].grid(row=kk, column=4)
